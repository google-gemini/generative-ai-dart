...
final class GenerativeModel {
  ...
  /// countTokens function for Vertex AI. The body of the request will be
  /// generated by Vertex AI SDK.
  Future<CountTokensResponse> _countTokensVertex(
      Map<String, Object?> body) async {
    final response =
        await _client.makeRequest(_taskUri(Task.countTokens), body);
    return parseCountTokensResponse(response);
  }
...
extension CountTokenVertexExtension on GenerativeModel {
  /// countTokens function for Vertex AI SDK
  Future<CountTokensResponse> countTokensVertex(Map<String, Object?> body) =>
      _countTokensVertex(body);
}
